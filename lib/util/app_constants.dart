...
class AppConstants {
  ...
  static const String clearAllWishListUri = '/api/v1/customer/wish-list/clear-all';
  ...
  /// order
  static const String getLastOrderUri = '/api/v1/customer/order/get-latest-list';
  ...
  /// Cart
  static const String getStoreCartListUri = '/api/v1/customer/cart/list';
  static const String getAllCartListUri = '/api/v1/customer/cart/get-all';
  static const String addCartUri = '/api/v1/customer/cart/add';
  static const String updateCartUri = '/api/v1/customer/cart/update';
  static const String removeCartBundleUri = '/api/v1/customer/cart/remove';
  ...
  // restaurant
  static const String restaurantCategoriesItem = '/api/v1/restaurant-categories/foods';
  ...
  static const String renewBottomSheetShown = 'stackfood_renew_bottomsheet_shown';
  ...
  /// Delivery Tips
  static List<String> tips = ['0' ,'250', '500', '1000', '2000', 'custom'];
  ...
  /// Deep Links
  static const String yourScheme = 'MyanFood';
  static const String yourHost = 'myanfoodmm.com';
